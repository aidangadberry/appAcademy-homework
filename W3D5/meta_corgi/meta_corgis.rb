# Snack box is a hash of boxes with box # as key corresponding to a hash of treats
# Each treat box is a hash of treat names as keys with a value of an attributes hash
# Each attributes hash has keys of "info" and "tastiness"
...
class MetaCorgiSnacks
  ...
  #   snack_names = ["bone", "kibble", "treat"]
  #
  #   if snack_names.include?(method_name)
